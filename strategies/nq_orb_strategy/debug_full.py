...
# Params
ENABLE_LONG = True; RR_LONG = 1.0     
ENABLE_SHORT = True; RR_SHORT = 1.0    
SL_STDEV_MULT = 0.5 
    ...
    with open(FILE_PATH, 'rb') as f:
        ...
        while True:
            ...
            for i in range(n):
                ...
                # Year logic simplified
                y = 0
                if ts > 1000000000000: # Valid MS
                     # 2020 start: 1.577e12
                     if ts < 1577836800000: y=2010
                     elif ts < 1609459200000: y=2020
                     elif ts < 1640995200000: y=2021
                     elif ts < 1672531200000: y=2022
                     elif ts < 1704067200000: y=2023
                     elif ts < 1735689600000: y=2024
                     else: y=2025
                else:
                    y = 1970
