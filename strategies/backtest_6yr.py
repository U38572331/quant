...
# Load Clean Data
print("Loading Clean DataBento data for Last 6 Years...")
df = pd.read_parquet(r'C:\Users\user\.gemini\antigravity\scratch\data\nq_clean_rth.parquet')

# Filter for the last 6 years (2020-2026)
df = df[df.index >= '2020-01-01'].copy()
df['date'] = df.index.date

trades = []

print("Running 6-Year R-unit Backtest...")
...
trades_df.to_csv(r'C:\Users\user\.gemini\antigravity\scratch\nq_6yr_trades.csv', index=False)
print(f"6-Year Results saved. Total Trades: {len(trades_df)}")
