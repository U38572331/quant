...
fig = make_subplots(rows=2, cols=1, shared_xaxes=True, vertical_spacing=0.1,
                    subplot_titles=("Total Strategy Equity (5m Confirm - R)", "Long vs Short Comparison (5m Confirm - R)"))
...
<head>
    <meta charset="UTF-8">
    <title>NQ 30m ORB 5分K確認版 (2020-2026)</title>
...
<body>
    <h1>NQ 30m ORB 最近六年回測 (5分K收盤確認)</h1>
    <div style="margin-bottom:20px; color:#94a3b8;">策略規則：5分K收盤價突破 ORB 高低點才進場 | 週期：2020-2026</div>
    <div class="grid">
